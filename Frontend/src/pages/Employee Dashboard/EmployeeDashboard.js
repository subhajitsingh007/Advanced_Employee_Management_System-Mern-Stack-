  ...
  const renderSection = () => {
    switch (section) {
      case "overview":
        return (
          <div>
            <h2 style={styles.welcomeText}>Hello, Ankita 👋</h2>
            <p style={styles.dateText}>Today is {time.toLocaleDateString()}</p>

            {/* Summary Cards */}
            <div style={styles.cardContainer}>
              <div style={styles.card}>
                <h3 style={styles.cardTitle}>Status</h3>
                <p style={styles.cardValue}>✅ Present</p>
              </div>
              <div style={styles.card}>
                <h3 style={styles.cardTitle}>Total Hours</h3>
                <p style={styles.cardValue}>6.5 hrs</p>
              </div>
              <div style={styles.card}>
                <h3 style={styles.cardTitle}>Leave Pending</h3>
                <p style={styles.cardValue}>2 Requests</p>
              </div>
            </div>
            ...
            <div style={styles.announcementSection}>
              ...
              <ul style={styles.announcementList}>
                <li style={styles.announcementItem}>Team meeting at 4 PM today.</li>
                <li style={styles.announcementItem}>New attendance rules will apply from next week.</li>
                <li style={styles.announcementItem}>HR is collecting documents for appraisal round.</li>
              </ul>
            </div>
          </div>
        );
